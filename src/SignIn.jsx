  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-6">
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="flex justify-center marrgin-top-10">
        ...
        <form className="mt-10 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              type="email"
              autoComplete="email"
              className="mt-2 block w-full rounded-md border border-gray-700 bg-gray-800 px-3 py-2 text-white outline-none focus:border-indigo-500"
            />
          </div>
